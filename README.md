...
```javascript
rescape = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-escape-regexp-string@v0.2.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/utils-escape-regexp-string@v0.2.0-umd/browser.js"></script>
```
